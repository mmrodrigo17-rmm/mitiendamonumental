...
├── index.html
├── vite.config.js                      ← Configuración base: '/mitiendamonumental/'
└── package.json
```
...
```bash
git clone https://github.com/mmrodrigo17-rmm/mitiendamonumental.git
cd mitiendamonumental
npm install
```
...
El servidor arranca en `http://localhost:5173/mitiendamonumental/`.
...
El proyecto deploya a **GitHub Pages** con subruta `/mitiendamonumental/`.
...
```
https://mmrodrigo17-rmm.github.io/mitiendamonumental/
```
